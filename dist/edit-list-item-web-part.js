define("30aa3f0d-8b25-471e-bfc8-4e8a656a9ce9_0.0.1", ["jquery","@microsoft/sp-core-library","@microsoft/sp-webpart-base","@microsoft/sp-property-pane","@microsoft/sp-loader","bootstrap","EditListItemWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_49__, __WEBPACK_EXTERNAL_MODULE_50__, __WEBPACK_EXTERNAL_MODULE_51__, __WEBPACK_EXTERNAL_MODULE_87__, __WEBPACK_EXTERNAL_MODULE_92__, __WEBPACK_EXTERNAL_MODULE_102__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
        ...
        function init() {
            ...
            $editor.append(
                $('<div />', {class: 'richText-toolbar'})
                    .append($('<a />', {class: 'richText-undo is-disabled', html: '<span class="fa fa-undo icon-none"></span>', 'title': settings.translations.undo}))
                    .append($('<a />', {class: 'richText-redo is-disabled', html: '<span class="fa fa-repeat fa-redo icon-none"></span>', 'title': settings.translations.redo}))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_EditListItemWebPartStrings__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_EditListItemWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_EditListItemWebPartStrings__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__commonJS__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__microsoft_sp_loader__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__microsoft_sp_loader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__microsoft_sp_loader__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ExternalRef_css_alertify_min_css__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ExternalRef_css_alertify_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__ExternalRef_css_alertify_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_cropper_min_css__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_cropper_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_cropper_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ExternalRef_css_richtext_min_css__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ExternalRef_css_richtext_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__ExternalRef_css_richtext_min_css__);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var EditListItemWebPart = /** @class */ (function (_super) {
    ...
    EditListItemWebPart.prototype.render = function () {
        __WEBPACK_IMPORTED_MODULE_7__microsoft_sp_loader__["SPComponentLoader"].loadCss('https://cdnjs.cloudflare.com/ajax/libs/croppie/2.6.3/croppie.css');
        var _this = this;
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CName").replace("%20", " ");
    ...
    EditListItemWebPart.prototype.EditListItem = function () {
        ...
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CName");
        strLocalStorage = strLocalStorage.split('%20').join(' ');
        var strLocalStorageBreadcrumb = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CName");
        ...
        document.getElementById("ComponentName").innerHTML = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CName").split("%20").join(" ");
        var strComponentId = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CID");
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (strLocalStorage == "Quick Launch") {
                            ...
                            if (isAllfield) {
                                ...
                                isAllfield = this.quickLaunchValidation();
                                Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])("Quick Launch", strComponentId, myobjQl);
                        ...
                        if (strLocalStorage == "Banners") {
                            ...
                            if (files.files.length > 0) {
                                ...
                                blob = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["c" /* base64ToArrayBuffer */])(file1[1]);
                            ...
                            if (isAllfield) {
                                if (files.files.length == 0) {
                                    ...
                                    $body.addClass("loading");
                                    Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])("Banners", strComponentId, myobjBanners).then(function (e) {
                                        if (e.data) {
                                            $body.removeClass("loading");
                                            that.pageBack();
                                        }
                                ...
                                $body.addClass("loading");
                                __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Images").files.add(uniquename, blob, true)
                                    .then(function (result) {
                                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Banners").items.getById(strComponentId).update({
                                        ID: strComponentId,
                                        Title: $("#txtTitle").val(),
                                        BannerContent: $('.richText-editor').html(),
                                        Image: {
                        ...
                        ItemID = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CID");
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("Media Gallery", ["MediaFileType"], 1, "Modified", "ID", ItemID)];
                    case 1:
                        ...
                        if (C_objResults[0].MediaFileType == "Image") {
                            ...
                            if (files.files.length == 0) {
                                ...
                                if (isAllfield) {
                                    $body.addClass("loading");
                                    Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])("Media Gallery", strComponentId, saveData).then(function (result) {
                                        $body.removeClass("loading");
                                        that.pageBack();
                                    });
                                }
                                ...
                                if (isAllfield) {
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Images").files.add(uniquename, blob, true)
                                        .then(function (result) {
                                        __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Media Gallery").items.getById(strComponentId).update({
                                            ID: strComponentId,
                                            Title: $("#txtTitle").val(),
                                            Image: {
                                                "__metadata": {
                            ...
                            C_ItemID = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CID");
                            U_ItemID = +C_ItemID;
                            ...
                            if (isAllfield) {
                                ...
                                $body.addClass("loading");
                                __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle(strLocalStorage).items.getById(U_ItemID).update(videoCols).then(function (result) {
                                    $body.removeClass("loading");
                    ...
                    case 2:
                        if (strLocalStorage == "Announcements") {
                            ...
                            if (isAllfield) {
                                $body.addClass("loading");
                                Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])(listName, ItemID, itemObj).then(function (result) {
                                    $body.removeClass("loading");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        renderDropdown = "";
                        renderNews = "";
                        strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CName");
                        strLocalStorage = strLocalStorage.split('%20').join(' ');
                        strComponentMode = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CMode");
                    ...
                    case 2:
                        ...
                        C_ItemID = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* GetQueryStringParams */])("CID");
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("Media Gallery", ["MediaFileType"], 1, "Modified", "ID", C_ItemID)];
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        strLocalStorage = strLocalStorage.split('%20').join(' ');
                        if (strLocalStorage == "Banners") {
                            objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("Banners", ["Title", "Modified", "BannerContent", "Display", "LinkURL", "Orders", "Image"], count, "Modified", "ID", strComponentId);
                        ...
                        if (!(strLocalStorage == "Media Gallery")) return [3 /*break*/, 2];
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("Media Gallery", ["LinkURL", "Display", "MediaFileType", "Image", "Title"], count, "Modified", "ID", strComponentId)];
                    case 1:
                        objResults = _a.sent();
                    ...
                    case 2:
                        if (strLocalStorage == "Quick Launch") {
                            objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("Quick Launch", ["Title", "Modified", "LinkURL", "Display"], count, "Modified", "ID", strComponentId);
                            objResults.then(function (items) {
                                $('#txtTitle').val(items[0].Title);
                                $('#txtHyper').val(items[0].LinkURL.Url);
                            });
                            ...
                            objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(listName, columnArray, 1, "Modified", "ID", 1);
                            objResults.then(function (items) {
    ...
    EditListItemWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_3_EditListItemWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_3_EditListItemWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_2__microsoft_sp_property_pane__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_3_EditListItemWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
