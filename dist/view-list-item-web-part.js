define("4fb9ec11-4226-4d93-bc17-34f2c495aa60_0.0.1", ["jquery","@microsoft/sp-core-library","@microsoft/sp-webpart-base","@microsoft/sp-property-pane","ViewListItemWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_49__, __WEBPACK_EXTERNAL_MODULE_50__, __WEBPACK_EXTERNAL_MODULE_51__, __WEBPACK_EXTERNAL_MODULE_104__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ViewListItemWebPartStrings__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ViewListItemWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_ViewListItemWebPartStrings__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__commonJS__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ExternalRef_css_richtext_min_css__ = __webpack_require__(84);
...
var userflag = false;
var ViewListItemWebPart = /** @class */ (function (_super) {
    ...
    ViewListItemWebPart.prototype.render = function () {
        var _this = this;
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CName").replace("%20", " ");
        // Checking user details in group
        Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["e" /* checkUserinGroup */])(strLocalStorage, this.context.pageContext.user.email, function (result) {
            if (result == 1) {
    ...
    ViewListItemWebPart.prototype.viewitemdesign = function () {
        var listName = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CName").replace("%20", " ");
    ...
    ViewListItemWebPart.prototype.FetchListItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var listName, ItemID, columnArray, GetListItems, _this, Doctype, Doctype, Doctype, DocName, ViewCount, node, strconfirm;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listName = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CName").replace("%20", " ");
                        ItemID = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CID");
                    ...
                    case 1:
                        ...
                        _this = this;
                        if (!(GetListItems.length > 0)) return [3 /*break*/, 15];
                    ...
                    case 2:
                        ...
                        $('#txtTitle').val(GetListItems[0].Title);
                        $('#txtStartDate').val(Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["h" /* formatDate */])(GetListItems[0].EventDate));
                        if ((GetListItems[0].EndEventDate) != null) {
                            GetListItems[0].EndEventDate = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["h" /* formatDate */])(GetListItems[0].EndEventDate);
                        }
                        else {
                    ...
                    case 3:
                        ...
                        $('#txtDate').val(Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["h" /* formatDate */])(GetListItems[0].Date));
                        $('#DocumentTitle').text(listName);
                        return [3 /*break*/, 14];
                    case 4:
                        ...
                        return [3 /*break*/, 14];
                    case 5:
                        if (!(listName == "Quick Launch")) return [3 /*break*/, 6];
                        $('#txtTitle').val(GetListItems[0].Title);
                        $('#txtHyperlink').val(GetListItems[0].LinkURL.Url);
                        $('#DocumentTitle').text("Quick Launch");
                        return [3 /*break*/, 14];
                    case 6:
                        if (!(listName == "Employee Corner")) return [3 /*break*/, 7];
                        ...
                        $('#txtTitle').val(GetListItems[0].Title);
                        $('#txtDate').val(Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["h" /* formatDate */])(GetListItems[0].Modified));
                        $('#DocumentTitle').text("Employee Corner");
                        return [3 /*break*/, 14];
                    case 7:
                        if (!(listName == "Organizational Policies")) return [3 /*break*/, 8];
                        Doctype = GetListItems[0].DocumentFile.Url.split(".");
                        Doctype = Doctype[Doctype.length - 1];
                        $('#cropped-img').attr('src', this.GetDocImages(Doctype));
                        $('a.Link').attr('href', GetListItems[0].DocumentFile.Url);
                        ...
                        return [3 /*break*/, 14];
                    case 8:
                        if (!(listName == "Corporate Discounts")) return [3 /*break*/, 9];
                        ...
                        return [3 /*break*/, 14];
                    case 9:
                        if (!(listName == "Events")) return [3 /*break*/, 10];
                        $('#View-img').attr('src', GetListItems[0].Image.Url);
                        $('#txtTitle').val(GetListItems[0].Title);
                        $('#txtDescription').val(GetListItems[0].Explanation);
                        $('#txtStartDate').val(Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["h" /* formatDate */])(GetListItems[0].StartDate));
                        if ((GetListItems[0].EndDate) != null) {
                            GetListItems[0].EndDate = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["h" /* formatDate */])(GetListItems[0].EndDate);
                        }
                        else {
                        ...
                        return [3 /*break*/, 14];
                    case 10:
                        if (!(listName == "Polls")) return [3 /*break*/, 11];
                        //$('#txtTitle').val(GetListItems[0].Title);
                        ...
                        return [3 /*break*/, 14];
                    case 11:
                        if (!(listName == "Media Gallery")) return [3 /*break*/, 12];
                        ...
                        return [3 /*break*/, 14];
                    case 12:
                        if (!(listName == "Announcements")) return [3 /*break*/, 14];
                        $('#View-img').attr('src', GetListItems[0].Image.Url);
                        $('#LblAnnounceTitle').text(GetListItems[0].Title);
                        $('#LblAnnounceExpiryDate').text(Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["h" /* formatDate */])(GetListItems[0].Expires));
    ...
    ViewListItemWebPart.prototype.renderhtml = function () {
        return __awaiter(this, void 0, void 0, function () {
            var listName, renderhtmlImage, renderimage, renderDate, renderTitle, renderDescription, renderEventDate, renderHyperlink, renderSitelink, renderQuestion, renderOptions, renderAnnounceBtns, renderExpiryDate, renderAnnounceTitle, renderAnnounceExpiry, renderAnnounceLike, renderAnnounceDesc, renderAnnounceTabs, renderAnnounceTabContent, renderAnnounceCommentTab, renderAnnounceCommentSubmit, renderAnnounceCommentcontent, renderDepartment, renderMediaVideoPlayer, ItemID, C_objResults, _this, Email, Closeevent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listName = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CName").replace("%20", " ");
                        ...
                        renderExpiryDate = "";
                        renderAnnounceTitle = "";
                        renderAnnounceExpiry = "";
                        renderAnnounceLike = "";
                        renderAnnounceDesc = "";
                        renderAnnounceTabs = "";
                        renderAnnounceTabContent = "";
                        renderAnnounceCommentTab = "";
                        renderAnnounceCommentSubmit = "";
                        renderAnnounceCommentcontent = "";
                        renderDepartment = "";
                        renderMediaVideoPlayer = "";
                        ...
                        renderAnnounceCommentcontent += '<ul class="nav nav-tabs" role="tablist">' +
                            ...
                            '</ul>';
                        if (!(listName == "Banners")) return [3 /*break*/, 1];
                        $('.form-imgsec').append(renderimage);
                        $('#Form-Part').append(renderTitle + renderDescription + renderHyperlink);
                        return [3 /*break*/, 4];
                    case 1:
                        if (!(listName == "Media Gallery")) return [3 /*break*/, 3];
                        ItemID = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CID");
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["j" /* readItems */])("Media Gallery", ["MediaFileType", "LinkURL", "Image",], 1, "Modified", "ID", ItemID)];
                    case 2:
                    ...
                    case 4:
                        ...
                        Closeevent = document.getElementById('closeicon');
    ...
    ViewListItemWebPart.prototype.SubmitComments = function () {
        ...
        if (this.AnnouncementValidation()) {
            var ItemID = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CID");
            var listName = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CName").replace("%20", " ");
            ...
            if (txtAnnounceDesc != 0) {
                ...
                var AddComments = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* addItems */])("AnnouncementComments", myobjHol);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).filter("User eq '" + filterValue + "' and AnnouncementID eq '" + ItemID + "'").top(1).orderBy("Modified").get()];
                    case 1:
                        GetLikes = _a.sent();
                        ...
                        AddLikes = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* addItems */])(listName, myobjHol);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        matchColumns = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["g" /* formString */])(Columns);
                        Html = "";
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).expand("Editor").filter("AnnouncementID eq '" + ItemID + "' and Liked eq 1").orderBy("Modified").get()];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Email = this.context.pageContext.user.email;
                        ItemID = parseInt(Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CID"));
                        _this = this;
                        $body = $("body");
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.site.rootWeb.ensureUser(Email).then(function (result) {
    ...
    ViewListItemWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_3_ViewListItemWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_3_ViewListItemWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_2__microsoft_sp_property_pane__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_3_ViewListItemWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
