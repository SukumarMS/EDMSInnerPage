define("3dc4109a-8ebd-4430-97e5-723718fafa69_0.0.1", ["jquery","@microsoft/sp-core-library","@microsoft/sp-webpart-base","@microsoft/sp-property-pane","@microsoft/sp-loader","bootstrap","AddListItemWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_49__, __WEBPACK_EXTERNAL_MODULE_50__, __WEBPACK_EXTERNAL_MODULE_51__, __WEBPACK_EXTERNAL_MODULE_87__, __WEBPACK_EXTERNAL_MODULE_92__, __WEBPACK_EXTERNAL_MODULE_97__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_AddListItemWebPartStrings__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__microsoft_sp_loader__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_jquery__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ExternalRef_css_bootstrap_datepicker_min_css__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_alertify_min_css__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_alertify_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_alertify_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ExternalRef_css_cropper_min_css__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ExternalRef_css_cropper_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__ExternalRef_css_cropper_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ExternalRef_css_richtext_min_css__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ExternalRef_css_richtext_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__ExternalRef_css_richtext_min_css__);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var AddListItemWebPart = /** @class */ (function (_super) {
    ...
    AddListItemWebPart.prototype.render = function () {
        __WEBPACK_IMPORTED_MODULE_5__microsoft_sp_loader__["SPComponentLoader"].loadCss("/sites/BloomHolding/_catalogs/masterpage/BloomHomepage/css/jquery-ui.min.css");
        ...
        __WEBPACK_IMPORTED_MODULE_5__microsoft_sp_loader__["SPComponentLoader"].loadScript("/sites/BloomHolding/_catalogs/masterpage/BloomHomepage/js/jquery-ui.min.js");
        var _this = this;
    ...
    AddListItemWebPart.prototype.AddItemPageLoad = function () {
        ...
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CName");
        ...
        document.getElementById("ComponentName").innerHTML = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["a" /* GetQueryStringParams */])("CName").split('%20').join(" ");
        // HIDE HTML
    ...
    AddListItemWebPart.prototype.QuickLaunchUpload = function () {
        ...
        if (isAllfield) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* addItems */])("Quick Launch", myobjQl).then(function () {
    ...
    AddListItemWebPart.prototype.BannerImageUpload = function () {
        ...
        var blob = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["c" /* base64ToArrayBuffer */])(file1[1]);
        var myobjQl = {
            Title: $("#txtTitle").val().trim(),
        ...
        if (isAllfield) {
            $body.addClass("loading");
            __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl(strLocalStorage).files.add(uniquename, blob, true).then(function (result) {
                result.file.listItemAllFields.get().then(function (listItemAllFields) {
                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle(strLocalStorage).items.getById(listItemAllFields.Id).update(myobjQl).then(function () {
                        $body.removeClass("loading");
    ...
    AddListItemWebPart.prototype.ImageGallUpload = function () {
        ...
        if (isAllfield) {
            ...
            __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Image Gallery").rootFolder.folders.add($('#txtFolderName').val())
                .then(function (data) {
                __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Image Gallery" + "/" + $('#txtFolderName').val()).files.add(file.name, file, true)
                    .then(function (result) {
                    $body.removeClass("loading");
                    window.history.back();
                });
        ...
        if (isAllfield) {
            ...
            __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Video Gallery").rootFolder.folders.add($('#txtFolderName').val())
                ...
                if (radioValue == "Upload") {
                    ...
                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Video Gallery" + "/" + $('#txtFolderName').val()).files.add(file.name, file, true)
                        .then(function (_a) {
                        var file = _a.file;
                        return file.getItem();
                    })
    ...
    AddListItemWebPart.prototype.MediaImageUpload = function () {
        ...
        if (isAllfield) {
            $body.addClass("loading");
            __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl(strLocalStorage).files.add(uniquename, file, true).then(function (result) {
                result.file.listItemAllFields.get().then(function (listItemAllFields) {
                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle(strLocalStorage).items.getById(listItemAllFields.Id).update(myobjQl).then(function (result) {
                        $('.addbutton').prop('disabled', true);
                        window.history.back();
                        $body.removeClass("loading");
                    });
    ...
    AddListItemWebPart.prototype.MediaVideoUpload = function () {
        ...
        if (isAllfield) {
            $body.addClass("loading");
            __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Media Gallery").files.add(uniquename, file, true)
                .then(function (result) {
                var videoCols = {
                ...
                result.file.listItemAllFields.get().then(function (listItemAllFields) {
                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle(strLocalStorage).items.getById(listItemAllFields.Id).update(videoCols).then(function (result) {
                        $body.removeClass("loading");
                        $('.addbutton').prop('disabled', true);
                        window.history.back();
                    });
